...
parser.add_argument("--predict", default="rental_competition.train.npz", type=str, help="Run prediction on given data")
...
def main(args: argparse.Namespace):
    if args.predict is None:
     ...
     #       ("huber", sklearn.linear_model.HuberRegressor(max_iter=10000))
                   ("poisson", sklearn.linear_model.PoissonRegressor(max_iter=1000))
        ])
